//! Text styling: formatting flags, font, and composite style for text components.
//!
...
///
/// ```
/// use oxidized_chat::{Style, TextColor, ChatFormatting};
///
...
mod tests {
    use super::*;
    use crate::hover_event::HoverItem;
