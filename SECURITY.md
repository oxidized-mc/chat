...
- Parsing vulnerabilities (malformed chat JSON/NBT causing panics or crashes)
- Memory safety issues (should be none — the crate enforces `#![deny(unsafe_code)]`)
- Denial of service via pathological input (deeply nested components, unbounded allocations)
