...
```bash
# 1. Fork and clone
git clone https://github.com/oxidized-mc/chat.git
cd chat
...
`oxidized-chat` is a library crate in the
...
Use `chat` as the scope for all changes to this crate.
